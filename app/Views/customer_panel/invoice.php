...
<section class="my-4">
  ...
  <a href="/CustomerPanel/Invoice/Laporan/<?= $data_transaksi['id_transaksi'] ?>" target="_blank"
      ...
      <div class="container mb-5 mt-3">
        ...
        <div class="container">
          ...
          <div class="row my-2 mx-1 justify-content-center">
            ...
            <div class="col-md-3 mb-4 mb-md-0">
              ...
              <button class="btn btn-primary"
                onclick="openReviewModal('<?= $item['id_produk']; ?>', '<?= $data_customer['id_customer']; ?>')"><i
                  class="fas fa-star px-1"></i> Review</button>
          ...
          <div class="row">
            <div class="col-xl-8">
              <p class="ms-3">
                <?php if ($data_transaksi['nama_ekspedisi'] == null) : ?>
                ...
                <?php else : ?>
                Pesanan telah diserahkan ke kurir dengan Kode RESI <br>
                <span class="badge bg-primary fw-bold"> <?= $data_transaksi['nama_ekspedisi']; ?> -
                  <?= $data_transaksi['nomor_resi']; ?></span>
                <?php endif ?>
              </p>
            </div>
            <?php
          ...
          <div class="col-12">
            ...
            <button type="button" class="btn btn-primary btn-lg btn-block no-print" data-mdb-ripple-init
              data-mdb-modal-init data-mdb-target="#uploadBukti">Pay Now</button>
            <?php endif ?>

            <?php if ($data_transaksi['status_transaksi'] == 'Pesanan diserahkan ke ekspedisi') : ?>
            <button type="button" class="btn btn-primary btn-lg btn-block no-print" data-mdb-ripple-init
              data-mdb-modal-init data-mdb-target="#pesananSelesai">Pesanan Selesai</button>
            <?php endif ?>
          </div>
        </div>
      </div>
      ...
      <form action="/CustomerPanel/UploadBuktiBayar" method="post" enctype="multipart/form-data">
        <div class="modal-body">
          ...
          <div class="mb-4">
            ...
            <input type="file" id="files" class="form-control" name="bukti_bayar"
              accept="image/jpg, image/jpeg, image/png, aplication/pdf" multiple required>
