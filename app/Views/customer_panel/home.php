...
<section class="my-4">
  <div class="row">
    <div class="col-3 col-md-3">
        ...
        <div class="card card-primary card-outline">
          ...
          <div class="card-body box-profile">
            ...
            <h3 class="profile-username text-center mt-1 text-primary">
              <?= session()->get('dataCustomer')['nama_customer']; ?></h3>

            <p class="text-muted text-center"><a href="#" data-mdb-ripple-init data-mdb-modal-init
                data-mdb-target="#ubahInformasi"><i class="fa fa-pencil"></i> Edit</a></p>
            ...
            <ul class="list-group list-group-unbordered mb-3">
              ...
              <li class="list-group-item">
                <b>Tarif Pengiriman</b> <span class="float-end">Rp
                  <?= number_format(session()->get('dataCustomer')['tarif'], 0, ',', '.'); ?></span>
              </li>
              <li class="list-group-item">
      ...
      <button class="btn btn-primary col-12 my-2" data-mdb-ripple-init data-mdb-modal-init
          ...
          <table class="table table-bordered table-sm" id="datatables">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><a href="/CustomerPanel/Invoice/<?= $item['id_transaksi']; ?>"
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="/CustomerPanel/Informasi" method="post">
        <div class="modal-body">
          ...
          <div class="form-outline mb-4" data-mdb-input-init>
            <input type="text" id="nama_customer" class="form-control" name="nama_customer"
              value="<?= session()->get('dataCustomer')['nama_customer'] ?>" required>
            <label for="nama_customer" class="form-label">Nama Customer</label>
          </div>

          <div class="form-outline mb-4" data-mdb-input-init>
            <input type="email" id="email_customer" class="form-control" name="email_customer"
              value="<?= session()->get('dataCustomer')['email_customer'] ?>" required>
            <label for="email_customer" class="form-label">Email</label>
          </div>

          <div class="input-group mb-3">
            <span class="input-group-text" id="basic-addon1">+62</span>
            <input type="text" class="form-control" placeholder="Nomor Whatsapp (Penerima Pemesanan)"
          ...
          <div data-mdb-input-init class="form-outline mb-3">
            <textarea class="form-control form-control-lg" name="alamat" id="alamat" placeholder="Alamat Lengkap"
              required rows="5"><?= session()->get('dataCustomer')['alamat']; ?></textarea>
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-mdb-ripple-init data-mdb-dismiss="modal">Keluar</button>
          <button id="submitbtn" type="submit" class="btn btn-primary" data-mdb-ripple-init>Simpan</button>
...
$(document).ready(function() {
  $('#kota option[value="<?= session()->get('dataCustomer')['nama_kota'] ?>"]').attr('selected', 'selected');
});
</script>
